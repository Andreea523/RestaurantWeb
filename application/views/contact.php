   ...
   crossorigin=""></script>
	...
	<div class="gtco-section">
        ...
        <div style="display: flex; flex-direction: column; ">
            ...
            <div style="margin-top: 25px; margin-bottom: 25px;">
                <canvas id="myCanvas" width="250" height="100" style="border:1px solid #000000;display:block; margin: 0 auto;">
                </canvas>
                <script>
          ...
          <div id="mapid" style="width: 400px; height: 300px;"></div>
                <script>
                    ...
                    var mymap = L.map('mapid').setView([47.1739427,27.5722875], 16);
			...
			'Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
                    ...
                    L.marker([47.1741119,27.5720117]).addTo(mymap).bindPopup("<b>Savory</b>").openPopup();
                </script>
          <div id="fb-root"></div>
                <script async defer src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v3.2"></script>
            <br/><br/>
            <div class="fb-like" data-href="http://www.rraducanu.ro" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
        
        
      </div>
						<ul>
							<li class="address">Bulevardul Carol I, nr. 11, Iasi 700506</li>
							<li class="phone"><a href="tel://+40 232 201 160">+40 232 201 160</a></li>
							<li class="email"><a href="mailto:math@uaic.com">math@uaic.com</a></li>
							<li class="url"><a href="https://w ww.math.uaic.ro/">Math</a></li>
						</ul>
					</div>
