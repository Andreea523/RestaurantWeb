...
<html>
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3 class="cursive-font">Table Reservation</h3>
                                                                                            ...
                                                                                            <?php echo form_open_multipart('MainController/addPeople'); ?>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" value="Add" class="btn btn-primary btn-block" value="Reserve Now">
													</div>
												</div>
                                                                                            <?php echo form_close();?>
	...
	<div id="gtco-counter" class="gtco-section">
		<div class="gtco-container">
			...
			<div class="row">
				<?php //modificat numarul la meniuri si restu?>
